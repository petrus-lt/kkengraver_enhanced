...
try: 
    ...
    print('  B. Burn test pattern Power vs. Depth, 40x40mm,   5x5 tiles, 8x8mm per tile, in steps of 20%')
    print('  C. Burn test pattern Power vs. Depth, 20x20mm,   5x5 tiles, 4x4mm per tile, in steps of 20%')
    print('  D. Burn test pattern Power vs. Depth, 40x40mm, 10x10 tiles, 4x4mm per tile, in steps of 10%')
    print('')
